            ...
            <section>
                ...
                <section>
                    ...
                    <div className="iconButtonContainer">
                        <button aria-label="홈 버튼" className="iconButton"><img src={home} /></button>
                        <button aria-label="웹 버튼" className="iconButton"><img src={web} /></button>
                        <button aria-label="메일 버튼" className="iconButton"><img src={mail} /></button>
                    </div>
                </section>
