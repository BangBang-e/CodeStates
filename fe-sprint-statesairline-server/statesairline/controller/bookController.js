...
module.exports = {
  ...
  create: (req, res) => {
    ...
    if (booking.find((book) => book.phone === phone && book.flight_uuid === flight_uuid)) {
      ...
      const booking_data = {
        booking_uuid,
        ...req.body
        //* flight_uuid: req.flight.uuid,
        //* name: req.flight.name,
        //* phone: req.flight.phone,
      }
  ...
  deleteByBookingId: (req, res) => {
    ...
    // TODO:
    const delete_booking = booking.filter((book) => {
      return book.flight_uuid !== flight_uuid
    })
    return res.json(delete_booking)
  }
};
